...
class ZetaPrints_WebToPrint_PhotothumbnailController extends Mage_Core_Controller_Front_Action {
  ...
  public function getAction () {
    ...
    $url = Mage::getStoreConfig('zpapi/settings/w2p_url') . '/photothumbs/' . $guid;
