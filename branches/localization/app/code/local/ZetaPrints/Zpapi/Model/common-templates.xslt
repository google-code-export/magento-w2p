      ...
      <div class="zetaprints-images-selector no-value minimized block">
        <div class="head block-title">
          <a class="image up-down" href="#">
            <span><xsl:call-template name="trans">
          ...
          <ul class="tab-buttons">
            <xsl:if test="@AllowUpload='1'">
              <li>
                ...
                <a href="#page-{$page}-tabs-{position()}-1">
                  <span><xsl:call-template name="trans">
                      <xsl:with-param name="key">Upload</xsl:with-param>
                    </xsl:call-template>
                  </span>
              ...
              <li class="hidden">
                <div class="icon user-images">
                  <span><xsl:call-template name="trans">
                      <xsl:with-param name="key">My images</xsl:with-param>
                    </xsl:call-template>
                  </span>
                </div>
                <a href="#page-{$page}-tabs-{position()}-2">
                  <span><xsl:call-template name="trans">
                      <xsl:with-param name="key">My images</xsl:with-param>
                    </xsl:call-template>
                  </span>
            ...
            <xsl:if test="StockImage">
              <li>
                <div class="icon stock-images">
                  <span><xsl:call-template name="trans">
                      <xsl:with-param name="key">Stock images</xsl:with-param>
                    </xsl:call-template>
                  </span>
                </div>
                <a href="#page-{$page}-tabs-{position()}-3">
                  <span><xsl:call-template name="trans">
                      <xsl:with-param name="key">Stock images</xsl:with-param>
                    </xsl:call-template>
                  </span>
            ...
            <xsl:if test="@ColourPicker='RGB'">
              <li>
                ...
                <a href="#page-{$page}-tabs-{position()}-4">
                  <span><xsl:call-template name="trans">
                      <xsl:with-param name="key">Color picker</xsl:with-param>
                    </xsl:call-template>
                  </span>
          ...
          <div class="tabs-wrapper">
            <xsl:if test="@AllowUpload='1'">
              <div id="page-{$page}-tabs-{position()}-1" class="tab upload">
                <div class="column">
                  ...
                  <label><xsl:call-template name="trans">
                ...
                <div class="column">
                  ...
                  <div class="button upload-file disabled">
                    <span><xsl:call-template name="trans">
            ...
            <xsl:if test="@ColourPicker='RGB'">
              <div id="page-{$page}-tabs-{position()}-4" class="tab color-picker">
                ...
                <span>
                  <a href="#"><xsl:call-template name="trans">
