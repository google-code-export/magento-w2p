      ...
      onComplete: function (file, response) {
        ...
        $(trs).each(function () {
          ...
          var td = $('<td>'
                   ...
                   + '<a class="edit-dialog-img" href="' + response[1] + '" target="_blank" tabindex="-1">'
                   + '<img src="' + response[2] + '" class="userImageThumb ' + response[0] + '" /></a> '
                   + '<div class="edit-dialog-context-menu">'
                   + '<a class="edit-dialog edit-submenu" href="' + response[1] + '" target="_blank" tabindex="-1">'
                   + '<div class="edit-button"><div>' + edit_and_save_button_text + '</div></div>'
                   + '</a>'
                   + '<a class="edit-dialog edit-submenu fit-in-field" href="' + response[1] + '" target="_blank" tabindex="-1">'
                   + '<div class="edit-button"><div>' + fit_in_field_button_text + '</div></div>'
                   + '</a>'
                   + '</div>'
                   + '<div class="edit-dialog-context-menu-root">'
                   + '<a href="javascript:void(1)" class="edit-dialog edit-menuroot" tabindex="-1">'
